...
namespace Personal.GenFunction;

public class GenFunction
{
    private readonly ILogger<GenFunction> _logger;

    public GenFunction(ILogger<GenFunction> logger)
    {
        _logger = logger;
    }
        ...
        string blobName)
    {
        ...
        string secretName = "storageAccountLeginSAS";
